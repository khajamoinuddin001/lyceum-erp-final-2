...
router.get('/lms/courses', async (req: Request, res: Response) => {
    try {
...
router.get('/logs/payment', async (req: Request, res: Response) => {
    try {
...
router.get('/accounting/transactions', async (req: Request, res: Response) => {
    try {
...
router.get('/crm/quotation-templates', async (req: Request, res: Response) => {
    try {
...
router.get('/reception/visitors', async (req: Request, res: Response) => {
    try {
...
router.get('/discuss/channels', async (req: Request, res: Response) => {
    try {
...
router.get('/lms/coupons', async (req: Request, res: Response) => {
    try {
